...
<h2 align="center"><font color="white">Stationary</font></h2>
...
PreparedStatement ps=DB.getConnection().prepareStatement("select model,image,price,adp from ImageUpload where itemname='Stationary';");
