...
<div class="shell">
  ...
  <div id="main">
   ...
   <%String message= "";
					  ...
					  <h3><%out.println("<h3>"+message+"<h3>");%></h3>
				  
<form name="frm" action="McartView.jsp" method="post" onSubmit="return validateFrm();">
<%
try{
PreparedStatement ps=DB.getConnection().prepareStatement("select distinct Uname from Mcart");
