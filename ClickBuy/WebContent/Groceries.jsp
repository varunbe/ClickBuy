...
<h2 align="center"><font color="white">Groceries</font></h2>
...
PreparedStatement ps=DB.getConnection().prepareStatement("select model,image,price,adp from ImageUpload where itemname='Groceries';");
...
<td><h3><%=S %>
 ...
 Qty<input type="number"  max="5" min="1" name = "<%=S%>"/> </input></td>
  <%}while(rs.next());%>
</tr>
<%
} catch (Exception e) {
