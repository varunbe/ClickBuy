...
<div class="shell">
 ...
 <form name="frm" action="monthlycart1.jsp" method="get" onSubmit="return validateFrm();">
...
<h3>Welcome:<% if (session.getAttribute("Uname")!= null) {
 ...
 <div style="width:1000px;overflow: auto;height:500px" >
...
%>
<tr bgcolor="#DEB887">
<td><input type="checkbox" name="c1" value="<%=resultSet.getString(2) %>"/></td>
