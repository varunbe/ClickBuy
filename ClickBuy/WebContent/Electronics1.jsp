...
<h2 align="center"><font color="white">Electronics</font></h2>

<form name="frmOne"   onSubmit="return validateSearch2();">
...
PreparedStatement ps=DB.getConnection().prepareStatement("select model,image,price,adp from ImageUpload where itemname='Electronics';");
